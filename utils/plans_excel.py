...
def get_plans_from_excel(data:DataFrame):
    """
    Дістає дані з основного листа надісланої книги
    Args:
            data: плани з excel файлу
    """
    excel_plan = {}
    for id in data.index:
        try:
            ...
            raise HTTPException(status_code=404, detail="""Неправильно названі колонки в листі. 
                                Мають бути: місяць плану, назва категорії плану, сума""")
...
def check_data(plans:dict):
    """перевіряє валідність плани, при помилці - повертає їх"""
    for plan in plans:
